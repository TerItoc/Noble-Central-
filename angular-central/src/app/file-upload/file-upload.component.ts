...
export class FileUploadComponent implements OnInit {
  ...
  upload() {
    if (!this.fileToUpload) {
      this.toastr.error(
        'Asegurese que haya seleccionado un archivo',
        'Error con tu archivo'
      );
      return;
    }
    ...
    this.teamSql.postFile(this.fileToUpload).subscribe((res) => {
      ...
      if (res.success) {
        ...
        this.toastr.error(
          'Asegurese que tenga el formato correcto',
          res.message
        );
      }
